...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['aktiviraj']) && isset($_POST['id'])) {
	$id = escape($_POST['id']);
...
<?php include 'layouts/header.php'; ?>
	<title>HELP AP - Spisak deaktiviranih korisnika</title>
</head>
<body class="bg-primary">
	<?php include 'layouts/nav.php'; ?>
	<div class="container py-5">
		<div class="text-center text-white">
			<h1 class="mb-5">Spisak deaktiviranih korisnika</h1>
		</div>
				...
				<tr>
					...
					<td>
						<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
							...
							<input type="submit" name="aktiviraj" value="Aktiviraj" class="btn btn-sm btn-outline-light">
						</form>
					</td>
				</tr>
				<?php } } ?>
